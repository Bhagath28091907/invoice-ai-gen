...
export const ClientInformationForm = ({ register, setValue, watch }: ClientInformationFormProps) => {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Select value={clientState} onValueChange={(value) => setValue("clientState", value)}>
            <SelectTrigger>
